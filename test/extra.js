...
describe('API Extra Routes', function() {
    ...
    describe('#near', function() {
        it('should return facilties with 1km', function(done) {
            request(url)
                .get("facilities/near/40.7645704/-73.9570783/1/km")
        ...
        it('should return facilities within 1mi', function(done) {
            request(url)
                .get("facilities/near/40.7645704/-73.9570783/1")
                .expect('Content-Type', /json/)
                .expect(200) 
                .end(function(err, res) {
                    if (err) {
        ...
        it('should return 1 facilities within 0km', function(done) {
             request(url)
                .get("facilities/near/40.7645704/-73.9570783/0/km")
                .expect('Content-Type', /json/)
                .expect(200) 
                .end(function(err, res) {
                    if (err) {
        ...
        it('should return no facilities', function(done) {
             request(url)
                .get("facilities/near/0.0/0.0/0/km")
                .expect('Content-Type', /json/)
                .expect(404) 
                .end(function(err, res) {
                    if (err) {
    ...
    describe('#within', function() {
        ...
        function(done) {
            request(url)
                .get("facilities/within/0/-180/90/0")
                .expect('Content-Type', /json/)
                .expect(200) 
                .end(function(err, res) {
                    if (err) {
        ...
        function(done) {
            request(url)
                .get("facilities/within/40.7645704/-73.9570783/40.7645704/-73.9570783")
                .expect('Content-Type', /json/)
                .expect(200) 
                .end(function(err, res) {
                    if (err) {
    ...
    describe('#withinSector', function() {
        ...
        function(done) {
            request(url)
                .get("facilities/within/0/-180/90/0/health")
                .expect('Content-Type', /json/)
                .expect(200) 
                .end(function(err, res) {
                    if (err) {
        ...
        function(done) {
            request(url)
                .get("facilities/within/40.7645704/-73.9570783/40.7645704/-73.9570783/health")
                .expect('Content-Type', /json/)
                .expect(200) 
                .end(function(err, res) {
                    if (err) {
        ...
        it('should return no facilities', function(done) {
            request(url)
                .get("facilities/within/0/0/0/0/health")
                .expect('Content-Type', /json/)
                .expect(404) 
                .end(function(err, res) {
                    if (err) {
