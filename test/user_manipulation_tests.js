    ...
    describe('User Creation', function() {
        ...
        it('should fail to create a duplicate user', function(done) {
            UserModel.addUser("Bob", "test", function(success) {
                ...
                // second request
                request(server)
                  .post(conf.prePath + '/users/add/?username=Bob&password=test2')
                  .expect('Content-Type', /json/)
                  .expect(400)
                  .end(function(err, res) {
                      if (err) {
        ...
        it('should fail to create a user with no pass', function(done) {
            request(server)
                 .post(conf.prePath + '/users/add/?username=Bob')
                 .expect('Content-Type', /json/)
                 .expect(400)
                 .end(function(err, res) {
                     if (err) {
    ...
    describe('update User', function() {
        it('should update password of user Bob', function(done) {
            UserModel.addUser("Bob", "test", function(success) {
                ...
                // second request
                request(server)
                    .put(conf.prePath + '/users/Bob/?password=test2')
                    .expect('Content-Type', /json/)
                    .expect(200)
                    .end(function(err, res) {
                        if (err) {
        ...
        it('should update password of user Bob', function(done) {
            UserModel.addUser("Bob", "test", function(success) {
                ...
                // second request
                request(server)
                    .put(conf.prePath + '/users/Bob/?role=admin')
                    .expect('Content-Type', /json/)
                    .expect(200)
                    .end(function(err, res) {
                        if (err) {
        ...
        it('should fail to update user Joe', function(done) {
            UserModel.addUser("Bob", "test", function(success) {
                ...
                // second request
                request(server)
                    .put(conf.prePath + '/users/Joe/?role=admin')
                    .expect('Content-Type', /json/)
                    .expect(400)
                    .end(function(err, res) {
                        if (err) {
        ...
        it('should update password and role of user Bob', function(done) {
            UserModel.addUser("Bob", "test", function(success) {
                ...
                // second request
                request(server)
                    .put(conf.prePath + '/users/Bob/?password=test2&role=admin')
                    .expect('Content-Type', /json/)
                    .expect(200)
                    .end(function(err, res) {
                        if (err) {
